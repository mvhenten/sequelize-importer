...
function define(stm) {
    var name = camelize(stm.value),
        ...
        str = sprintf('Models.%s = Db.define( "%s", %s, %s )', name, name, fields(stm.children), config);
...
module.exports = function render(ast) {
    ...
    return sprintf('module.exports = function( Db, Sequelize ){ var Models = {};\n %s;\n return Models; }', js.join(';\n'));
};
